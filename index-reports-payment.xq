        ...
        <div class="main-content"> 
        	<h1>Payment Reports</h1>
				<form name="form" method="get" action="index-reports-payment.xq" id="form">
					...
					<input type="date" name="startDate" style="width:150px" id="startDate" size="50" value="{xdmp:get-request-field("startDate")}"/><br/>
					
					<label for="endDate">End Date: </label>
					<input type="date" name="endDate" style="width:150px"  id="endDate" size="50" value="{xdmp:get-request-field("endDate")}"/><br/>
