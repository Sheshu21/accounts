...
declare function local:result-controller()
{
  ...
  then (:(local:display-ledger()):)(xdmp:get-request-field("supplierName"))
  else 
...
<body>
  <div class="gridContainer clearfix">
      <div class="header"><h1>Mohan Automobiles</h1><button><a href="utils.xqy">Back to Home Page</a></button><br/><h2>Reports</h2></div>
        <div class="section">
          <div class="main-column">  
            <div id="form">
              <form name="form" method="get" action="utils.xqy" id="form">
                  <p>Please select the report Type:</p>
                  <input required="true" type="radio" id="tradeLedger" name="tradeLedger" value="{xdmp:get-request-field("supplierName")}"/>
                  <label for="tradeLedger">&emsp;Trade Ledger</label><br/>
                    ...
                    <br/><button><a href="utils.xqy">Refresh/Reset</a></button><br/><br/>
